  ...
  <section class="top_business">
    <div class="container">
      ...
      <p class="top_business--txt">
        当社は、東海エリアを中心とした市場配送（定期便）および一般貨物配送（大手運送会社等）を基盤に、幅広い物流サービスを展開しています。さらに、関東・関西エリアへの産地便輸送や、地場エリアでの集荷業務にも対応し、地域と広域をつなぐ柔軟な輸送ネットワークを構築しています。取扱品目は、青果物をはじめとする生鮮品や一般貨物まで多岐にわたり、特に鮮度や品質が求められる青果物の輸送においては、確実で迅速な配送体制を整えています。私たちは「安全・安心・確実」をモットーに、物流を通じてお客様の事業活動を支えるとともに、地域社会の発展に貢献してまいります。
      </p>
      <ol>
        <li class="is_fadein">
